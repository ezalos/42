...
/*   Updated: 2019/03/05 17:26:03 by ldevelle         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../includes/head.h"

int		execute_swap(t_tab **stack, size_t size)
{
	int		swap;
...
int		move_stack(t_tab **stack, size_t size, int direction)
{
	size_t	i;
...
int		execute_order_66(t_push_swap *push)
{
	if (!ft_strcmp(push->instruction, "sa"))
		...
		execute_rotation(&push->stack_a, 1);
	else if (!ft_strcmp(push->instruction, "rrb"))
		execute_rotation(&push->stack_b, 1);
